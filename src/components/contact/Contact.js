...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    .then(
      (result) => { 
        if(result.text === "OK"){
          window.alert("Thank You for Reaching Me")
        }
      },
      (error) => {
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">pullolla.pothanna@gmail.com</span>
              <a
            ...
            <div className="contact_card"> 
              ...
              <a
                href="https://www.linkedin.com/in/pothanna"
                className="contact_button"
              >
                Write Me
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
            ...
            <div className="contact_card">
              <i className="bx bxs-phone-call contact_card-icon"></i>
              <h3 className="contact_card-title">For Call</h3>
              <span className="contact_card-data">+91 9059075850</span>
              {/* <a
